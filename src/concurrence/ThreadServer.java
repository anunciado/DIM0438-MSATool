...
public class ThreadServer extends Thread {
    ...
    private int numberClients; /** The number of clients connect with the socket */
     ...
     * @param numberClients
     */
    public ThreadServer(Socket sslSocketToProxy, int numberClients) {
    ...
    public void run() {
    	try {
            ...
            try (BufferedReader bufferedReader = new BufferedReader(new InputStreamReader(sslSocketToProxy.getInputStream()))) {
                ...
                if(message.equals("How many")) {
                	outProxy.println(numberClients);
                }
                else {
